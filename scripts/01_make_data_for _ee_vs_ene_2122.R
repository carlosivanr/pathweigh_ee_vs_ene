...
# processing
load(here("../dataset_20221017/data/20221017.RData"))
...
#save(data, meds_aom.ee, meds_aom.ene, file = here("data", "ee_vs_ene_processed2122.rda"))